    ...
    <div className="searchDiv grid gap-7 bg-greyIsh rounded-[10px] p-[3rem]">
      <form action="">
        <div className="firstDiv flex justify-between items-center rounded-[8px] gap-[70px] bg-white p-5 shadow-lg shadow-greyIsh-700 ">
            ...
            <button className='bg-blueColor h-full p-3 px-10 rounded-[10px] text-white cursor-pointer  hover:bg-blue-400'>Search</button>
        </div>
      </form>
      ...
      <div className="secDiv flex items-center gap-10 justify-center">
        ...
        <div className="singleSearch flex items-center gap-2">
          <label htmlFor="tyoe" className='text-[#808080] font-semibold'>Type:</label>
